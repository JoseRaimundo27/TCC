...
Este trabalho teve como objetivo principal desenvolver um modelo híbrido baseado em Simulação a Eventos Discretos (DES), Modelagem Baseada em Agentes (ABM) e Sistemas a Eventos Discretos (SED) para análise do comportamento humano e diagnóstico de falhas em processos de montagem e desmontagem de fôrmas em um contexto de construção civil.
