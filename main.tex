...
% TCC 2:
\preambulo{Trabalho de Conclusão de Curso apresen-
	tado ao Curso de Graduação em Engenharia
	de Computação da Universidade Federal da
	Bahia como parte dos requisitos para a obten	ção do grau de Engenheiro de Computação.}
